...
### Changes to validator scope/lifetime

When registering validators in ASP.NET Core projects, the default service lifetime is now `Scoped` rather than `Transient`.
