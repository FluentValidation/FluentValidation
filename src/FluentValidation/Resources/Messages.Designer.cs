...
//TODO Portk - having namespace as FluentValidation.Resources doesn't seem to work in vNext right now. Changing this to FluentValidation as a temporary work around until the bug is fixed.
#if !CoreCLR
...
#else
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("FluentValidation.K.Messages", typeof(Messages).GetTypeInfo().Assembly);
#endif
                    resourceMan = temp;
                }
                return resourceMan;
