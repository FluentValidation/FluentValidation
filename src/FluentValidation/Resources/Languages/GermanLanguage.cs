...
namespace FluentValidation.Resources {
	...
	internal class GermanLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(MinCountListValidator) => "'{PropertyName}' muss mindestens '{ValueToCompare}' Elemente enthalten.",
			nameof(MaxCountListValidator) => "'{PropertyName}' muss höchstens '{ValueToCompare}' Elemente enthalten.",
