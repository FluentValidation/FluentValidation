...
namespace FluentValidation.Resources {
	...
	internal class GermanLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"ExclusiveBetweenValidator" => "'{PropertyName}' muss zwischen {From} und {To} sein (exklusiv). Es wurde {Value} eingegeben.",
			"InclusiveBetweenValidator" => "'{PropertyName}' muss zwischen {From} and {To} sein. Es wurde {Value} eingegeben.",
