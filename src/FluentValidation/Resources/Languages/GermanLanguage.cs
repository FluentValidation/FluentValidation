...
namespace FluentValidation.Resources {
	...
	internal class GermanLanguage : Language {
		...
		public GermanLanguage() {
			...
			Translate<MinimumLengthValidator>("Die Länge von '{PropertyName}' muss zwischen {MinLength} und {MaxLength} Zeichen liegen. Es wurden {TotalLength} Zeichen eingetragen.");
			Translate<MaximumLengthValidator>("Die Länge von '{PropertyName}' muss zwischen {MinLength} und {MaxLength} Zeichen liegen. Es wurden {TotalLength} Zeichen eingetragen.");
