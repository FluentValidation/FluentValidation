...
namespace FluentValidation.Resources {
	...
	internal class PolishLanguage : Language {
		...
		public PolishLanguage() {
			...
			Translate<MinimumLengthValidator>("Długość pola '{PropertyName}' musi się zawierać pomiędzy {MinLength} i {MaxLength} znaki(ów). Wprowadzono {TotalLength} znaki(ów).");
			Translate<MaximumLengthValidator>("Długość pola '{PropertyName}' musi się zawierać pomiędzy {MinLength} i {MaxLength} znaki(ów). Wprowadzono {TotalLength} znaki(ów).");
