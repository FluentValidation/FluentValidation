...
namespace FluentValidation.Resources {
	...
	internal class DutchLanguage : Language {
		...
		public DutchLanguage() {
			...
			Translate<MinimumLengthValidator>("De lengte van '{PropertyName}' moet tussen {MinLength} en {MaxLength} karakters zijn. Er zijn {TotalLength} karakters ingevoerd.");
			Translate<MaximumLengthValidator>("De lengte van '{PropertyName}' moet tussen {MinLength} en {MaxLength} karakters zijn. Er zijn {TotalLength} karakters ingevoerd.");
