...
namespace FluentValidation.Resources {
	...
	internal class DutchLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"GreaterThanOrEqualValidator" => "'{PropertyName}' moet meer dan of gelijk zijn aan '{ComparisonValue}'.",
			...
			"LessThanOrEqualValidator" => "'{PropertyName}' moet minder dan of gelijk zijn aan '{ComparisonValue}'.",
			"LessThanValidator" => "'{PropertyName}' moet minder zijn dan '{ComparisonValue}'.",
