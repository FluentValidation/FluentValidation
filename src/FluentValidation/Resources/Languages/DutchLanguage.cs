...
namespace FluentValidation.Resources {
	...
	internal class DutchLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(GreaterThanOrEqualValidator) => "'{PropertyName}' moet groter zijn dan of gelijk zijn aan '{ComparisonValue}'.",
			...
			nameof(LessThanOrEqualValidator) => "'{PropertyName}' moet kleiner zijn dan of gelijk zijn aan '{ComparisonValue}'.",
			nameof(LessThanValidator) => "'{PropertyName}' moet kleiner zijn dan '{ComparisonValue}'.",
