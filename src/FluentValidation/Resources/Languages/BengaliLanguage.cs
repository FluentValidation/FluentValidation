...
namespace FluentValidation.Resources {
	...
	internal class BengaliLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' অবশ্যই {From} থেকে {To} এর মধ্যে হবে। আপনি {Value} প্রদান করেছেন।",
			"ExclusiveBetweenValidator" => "'{PropertyName}' অবশ্যই {From} থেকে {To} এর বাহিরে হবে না। আপনি {Value} প্রদান করেছেন।",
