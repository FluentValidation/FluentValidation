...
namespace FluentValidation.Resources {
	...
	internal class CroatianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' mora biti između {From} i {To}. Upisali ste {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' mora biti između {From} i {To} (ne uključujući granice). Upisali ste {Value}.",
