...
namespace FluentValidation.Resources {
	...
	internal class RussianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' Обязано быть от {From} до {To}. Вы ввели {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' должно быть между {From} и {To} (не включая). Вы ввели {Value}.",
