...
namespace FluentValidation.Resources {
	...
	internal class SpanishLanguage : Language {
		...
		public SpanishLanguage() {
			...
			Translate<ScalePrecisionValidator>("'{PropertyName}' no debe tener más de {expectedPrecision} dígitos en total, con margen para {expectedScale} decimales. Se encontraron {dígitos dígitos} y {realesEscala} decimales.");
