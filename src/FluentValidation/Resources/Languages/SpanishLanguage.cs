...
namespace FluentValidation.Resources {
	...
	internal class SpanishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(ExclusiveBetweenValidator) => "'{PropertyName}' debe estar entre {From} y {To} (exclusivo). Actualmente tiene un valor de {Value}.",
			nameof(InclusiveBetweenValidator) => "'{PropertyName}' debe estar entre {From} y {To}. Actualmente tiene un valor de {Value}.",
			...
			nameof(MinCountListValidator) => "'{PropertyName}' debe tener elementos '{ValueToCompare}' como mínimo.",
			nameof(MaxCountListValidator) => "'{PropertyName}' debe tener elementos '{ValueToCompare}' como máximo.",
