...
namespace FluentValidation.Resources {
	...
	internal class AzerbaijaneseLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"NotEqualValidator" => "'{PropertyName}', '{ComparisonValue}' dəyərində bərabər olmamalıdır.",
			"NotNullValidator" => "'{PropertyName}' daxil edilməlidir.",
			"PredicateValidator" => "'{PropertyName}' təyin edilmiş hala uyğun deyil.",
			"AsyncPredicateValidator" => "{PropertyName}' təyin edilmiş hala uyğun deyil.",
			"RegularExpressionValidator" => "'{PropertyName}' dəyərinin formatı doğru değil.",
