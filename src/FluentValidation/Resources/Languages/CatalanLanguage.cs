...
internal class CatalanLanguage {
	...
	public static string GetTranslation(string key) => key switch {
		...
		"LengthValidator" => "'{PropertyName}' ha de tenir entre {MinLength} i {MaxLength} caràcter/s. Actualment té {TotalLength} caràcter/s.",
		"MinimumLengthValidator" => "'{PropertyName}' ha de ser més gran o igual que {MinLength} caràcter/s. Ha inserit {TotalLength} caràcter/s.",
		"MaximumLengthValidator" => "'{PropertyName}' ha de ser menor o igual que {MaxLength} caràcter/s. Ha inserit {TotalLength} caràcter/s.",
		...
		"ExactLengthValidator" => "'{PropertyName}' ha de tenir una llargada de {MaxLength} caràcter/s. Actualment té {TotalLength} caràcter/s.",
		...
		"Length_Simple" => "'{PropertyName}' ha de tenir entre {MinLength} i {MaxLength} caràcter/s.",
		"MinimumLength_Simple" => "'{PropertyName}' ha de ser més gran o igual que {MinLength} caràcter/s.",
		"MaximumLength_Simple" => "'{PropertyName}' ha de ser menor o igual que {MaxLength} caràcter/s.",
		"ExactLength_Simple" => "'{PropertyName}' ha de tenir una longitud de {MaxLength} caràcter/s.",
