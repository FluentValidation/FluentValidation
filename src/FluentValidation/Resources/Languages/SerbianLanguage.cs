...
namespace FluentValidation.Resources {
	...
	internal class SerbianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' mora biti između {From} i {To}. Uneseno je {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' mora biti između {From} i {To} (ekskluzivno). Uneseno je {Value}.",
