...
namespace FluentValidation.Resources {
	...
	internal class HindiLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(MinCountListValidator) => "'{PropertyName}' में कम से कम '{ValueToCompare}' आइटम होना चाहिए",
			nameof(MaxCountListValidator) => "'{PropertyName}' में अधिक से अधिक '{ValueToCompare}' आइटम होने चाहिए।",
