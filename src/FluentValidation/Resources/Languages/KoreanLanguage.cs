...
namespace FluentValidation.Resources {
	...
	internal class KoreanLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"ExclusiveBetweenValidator" => "'{PropertyName}'은(는) {From} 이상 {To} 미만이어야 합니다. 입력한 값은 {Value}입니다.",
			...
			"InclusiveBetweenValidator" => "'{PropertyName}'은(는) {From} 이상 {To} 이하여야 합니다. 입력한 값은 {Value}입니다.",
