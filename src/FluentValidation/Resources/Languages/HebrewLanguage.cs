...
namespace FluentValidation.Resources {
	...
	internal class HebrewLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' חייב להיות בין {From} לבין {To}. הזנת {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' חייב להיות בין {From} לבין {To} (לא כולל). הזנת {Value}.",
