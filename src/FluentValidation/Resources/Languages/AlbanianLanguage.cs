...
namespace FluentValidation.Resources {
	...
	internal class AlbanianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' duhet të jetë midis {From} dhe {To}. Ju keni shkruar {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' duhet të jetë midis {From} dhe {To} (përjashtuese). Ju keni shkruar {Value}.",
