...
namespace FluentValidation.Resources {
	...
	internal class NorwegianBokmalLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' skal være mellom {From} og {To}. Du har tastet inn {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' skal være mellom {From} og {To} (eksklusiv). Du har tastet inn {Value}.",
