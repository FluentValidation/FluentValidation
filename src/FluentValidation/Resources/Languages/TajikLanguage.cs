...
internal class TajikLanguage {
	...
	public static string GetTranslation(string key) => key switch {
		...
		"LengthValidator" => "'{PropertyName}' бояд дар байни аломатҳои {MinLength} ва {MaxLength} бошад. Шумо {TotalLength} аломат ворид кардаед.",
		"MinimumLengthValidator" => "Дарозии '{PropertyName}' бояд ҳадди аққал {MinLength} аломат бошад. Шумо {TotalLength} аломат ворид кардаед.",
		"MaximumLengthValidator" => "Дарозии '{PropertyName}' бояд {MaxLength} аломат ё камтар бошад. Шумо {TotalLength} аломат ворид кардаед.",
		...
		"ExactLengthValidator" => "'{PropertyName}' бояд дарозии {MaxLength} аломат бошад. Шумо {TotalLength} аломат ворид кардед.",
		"InclusiveBetweenValidator" => "'{PropertyName}' бояд байни {From} ва {To} бошад. Шумо {PropertyValue}-ро ворид кардаед.",
		"ExclusiveBetweenValidator" => "'{PropertyName}' бояд байни {From} ва {To} (истисноӣ) бошад. Шумо {PropertyValue}-ро ворид кардаед.",
