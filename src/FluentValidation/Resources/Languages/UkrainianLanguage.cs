...
namespace FluentValidation.Resources {
	...
	internal class UkrainianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' має бути між {From} та {To} (включно). Ви ввели {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' має бути між {From} та {To}. Ви ввели {Value}.",
