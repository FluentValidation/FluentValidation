...
namespace FluentValidation.Resources {
	...
	internal class JapaneseLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' は {From} から {To} までの間でなければなりません。 {Value} と入力されています。",
			"ExclusiveBetweenValidator" => "'{PropertyName}' は {From} と {To} の間でなければなりません。 {Value} と入力されています。",
