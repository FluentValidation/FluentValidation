...
namespace FluentValidation.Resources {
	...
	public class DanishLanguage : Language {
		...
		public DanishLanguage() {
			...
			Translate<MinimumLengthValidator>("'{PropertyName}' skal være mellem {MinLength} og {MaxLength} tegn. Du har indtastet {TotalLength} tegn.");
			Translate<MaximumLengthValidator>("'{PropertyName}' skal være mellem {MinLength} og {MaxLength} tegn. Du har indtastet {TotalLength} tegn.");
