...
namespace FluentValidation.Resources {
	...
	internal class DanishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' skal være mellem {From} og {To}. Du har indtastet {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' skal være mellem {From} og {To} (eksklusiv). Du har indtastet {Value}.",
