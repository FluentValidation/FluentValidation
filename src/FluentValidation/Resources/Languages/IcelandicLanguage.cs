...
namespace FluentValidation.Resources {
	...
	internal class IcelandicLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' verður að frá {From} til {To}. Þú slóst inn {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' verður að vera á milli {From} og {To}. Þú slóst inn {Value}.",
