...
namespace FluentValidation.Resources {
	...
	internal class MacedonianLanguage : Language {
		...
		public MacedonianLanguage() {
			...
			Translate<MinimumLengthValidator>("Должината на '{PropertyName}' мора да биде помеѓу {MinLength} и {MaxLength} карактери. Имате внесено вкупно {TotalLength} карактери.");
			Translate<MaximumLengthValidator>("Должината на '{PropertyName}' мора да биде помеѓу {MinLength} и {MaxLength} карактери. Имате внесено вкупно {TotalLength} карактери.");
