...
namespace FluentValidation.Resources {
	...
	internal class PortugueseBrazilLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"ExclusiveBetweenValidator" => "'{PropertyName}' deve, exclusivamente, estar entre {From} e {To}. Você digitou {Value}.",
			"InclusiveBetweenValidator" => "'{PropertyName}' deve estar entre {From} e {To}. Você digitou {Value}.",
