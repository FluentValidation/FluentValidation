...
namespace FluentValidation.Resources {
	...
	internal class SwedishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "\"{PropertyName}\" måste vara mellan {From} och {To}. Du angav {Value}.",
			"ExclusiveBetweenValidator" => "\"{PropertyName}\" måste vara mellan {From} och {To} (gränsvärdena exkluderade). Du angav {Value}.",
