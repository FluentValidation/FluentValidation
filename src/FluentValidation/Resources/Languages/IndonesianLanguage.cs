...
namespace FluentValidation.Resources {
	...
	internal class IndonesianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' harus di antara {From} dan {To}. Anda memasukkan {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' harus di antara {From} dan {To} (exclusive). Anda memasukkan {Value}.",
