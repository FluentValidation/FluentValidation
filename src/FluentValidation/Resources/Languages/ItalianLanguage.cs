...
namespace FluentValidation.Resources {
	...
	internal class ItalianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(MinCountListValidator) => "'{PropertyName}' deve contenere almeno elementi '{ValueToCompare}'.",
			nameof(MaxCountListValidator) => "'{PropertyName}' deve contenere al massimo elementi '{ValueToCompare}'.",
