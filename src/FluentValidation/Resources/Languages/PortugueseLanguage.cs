...
namespace FluentValidation.Resources {
	...
	internal class PortugueseLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"ExclusiveBetweenValidator" => "'{PropertyName}' deve estar entre {From} e {To} (exclusivo). Introduziu {Value}.",
			"InclusiveBetweenValidator" => "'{PropertyName}' deve estar entre {From} e {To}. Introduziu {Value}.",
