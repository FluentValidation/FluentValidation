...
namespace FluentValidation.Resources {
	...
	internal class SlovenianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			nameof(MinimumLengthValidator) => "'{PropertyName}' mora imeti dolžino večjo ali enako {MinLength}. Vnesli ste {TotalLength} znakova.",
			nameof(MaximumLengthValidator) => "'{PropertyName}' mora imeti dolžino manjšo ali enako {MaxLength}. Vnesli ste {TotalLength} znakova.",
