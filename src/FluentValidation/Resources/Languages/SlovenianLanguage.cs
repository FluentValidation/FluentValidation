...
namespace FluentValidation.Resources {
	...
	internal class SlovenianLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' mora biti med {From} in {To}. Vnesli ste {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' mora biti med {From} in {To} (izključno). Vnesli ste {Value}.",
