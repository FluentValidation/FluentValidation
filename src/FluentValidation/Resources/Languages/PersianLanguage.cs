...
namespace FluentValidation.Resources {
	...
	internal class PersianLanguage : Language {
		...
		public PersianLanguage() {
			...
			Translate<MinimumLengthValidator>("'{PropertyName}' باید حداقل {MinLength} و حداکثر {MaxLength} کاراکتر داشته باشد. اما مقدار وارد شده {TotalLength} کاراکتر دارد.");
			Translate<MaximumLengthValidator>("'{PropertyName}' باید حداقل {MinLength} و حداکثر {MaxLength} کاراکتر داشته باشد. اما مقدار وارد شده {TotalLength} کاراکتر دارد.");
