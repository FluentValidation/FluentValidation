...
namespace FluentValidation.Resources {
	...
	internal class TurkishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}', {From} ve {To} arasında olmalı. {Value} değerini girdiniz.",
			"ExclusiveBetweenValidator" => "'{PropertyName}', {From} ve {To} (dahil değil) arasında olmalı. {Value} değerini girdiniz.",
