...
namespace FluentValidation.Resources {
	...
	internal class ArabicLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"InclusiveBetweenValidator" => "'{PropertyName}' يجب أن يكون بين {From} و {To}. ما تم ادخاله {Value}.",
			"ExclusiveBetweenValidator" => "'{PropertyName}' يجب أن يكون بين {From} و {To} (حصرياً). ما تم ادخاله {Value}.",
