...
namespace FluentValidation.Resources {
	...
	internal class FrenchLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"ExclusiveBetweenValidator" => "'{PropertyName}' doit être entre {From} et {To} (exclusif). Vous avez saisi {Value}.",
			"InclusiveBetweenValidator" => "'{PropertyName}' doit être entre {From} et {To}. Vous avez saisi {Value}.",
