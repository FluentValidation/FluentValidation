...
namespace FluentValidation.Validators {
	...
	public abstract class RangeValidatorBase<T, TProperty> : PropertyValidator<T, TProperty>, IBetweenValidator {

		readonly IComparer<TProperty> _explicitComparer;

		public RangeValidatorBase(TProperty from, TProperty to, IComparer<TProperty> comparer) {
			To = to;
			From = from;
