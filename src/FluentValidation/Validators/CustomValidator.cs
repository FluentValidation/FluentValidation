namespace FluentValidation.Validators {
	...
	public class CustomValidator<T, TProperty> : PropertyValidator {
		private readonly Action<TProperty, PropertyValidatorContext> _action;
		private Func<TProperty, PropertyValidatorContext, CancellationToken, Task> _asyncAction;
		...
		public CustomValidator(Action<TProperty, PropertyValidatorContext> action) {
			_isAsync = false;
			_action = action;
		...
		public CustomValidator(Func<TProperty, PropertyValidatorContext, CancellationToken, Task> asyncAction) {
			_isAsync = true;
