...
namespace FluentValidation.Validators {
	...
	public class ExclusiveBetweenValidator<TInstance, TProperty> : IPropertyValidator, IBetweenValidator<TProperty> where TProperty : IComparable<TProperty>, IComparable {
