...
namespace FluentValidation {
	...
	public enum CascadeMode {
		...
		/// </summary>
		[Obsolete("Use CascadeMode.StopFast instead. The behaviour of StopOnFirstFailure was ambiguous when used at validator-level. For more details, see https://docs.fluentvalidation.net/en/latest/conditions.html#setting-the-cascade-mode")]
		StopOnFirstFailure,
