...
namespace FluentValidation.AspNetCore {
	...
	public class FluentValidationMvcConfiguration {
		...
		[Obsolete("RegisterValidatorsFromAssemblyContaining is deprecated. Call services.AddValidatorsFromAssemblyContaining<T> instead, which has the same affect. See https://github.com/FluentValidation/FluentValidation/issues/1963")]
		...
		/// <param name="lifetime">The service lifetime that should be used for the validator registration. Defaults to Scoped</param>
		/// <param name="includeInternalTypes">Include internal validators. The default is false.</param>
		[Obsolete("RegisterValidatorsFromAssemblyContaining is deprecated. Call services.AddValidatorsFromAssemblyContaining instead, which has the same affect. See https://github.com/FluentValidation/FluentValidation/issues/1963")]
		...
		/// <param name="lifetime">The service lifetime that should be used for the validator registration. Defaults to Scoped</param>
		/// <param name="includeInternalTypes">Include internal validators. The default is false.</param>
		[Obsolete("RegisterValidatorsFromAssembly is deprecated. Call services.AddValidatorsFromAssembly instead, which has the same affect. See https://github.com/FluentValidation/FluentValidation/issues/1963")]
...
#pragma warning restore CS0618
		...
		/// <param name="lifetime">The service lifetime that should be used for the validator registration. Defaults to Scoped</param>
		/// <param name="includeInternalTypes">Include internal validators. The default is false.</param>
		[Obsolete("RegisterValidatorsFromAssemblies is deprecated. Call services.AddValidatorsFromAssemblies instead, which has the same affect. See https://github.com/FluentValidation/FluentValidation/issues/1963")]
