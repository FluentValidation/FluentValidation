...
namespace FluentValidation.Tests {
	...
	public class ValidatorTesterTester {
		...
		public ValidatorTesterTester() {
			...
			validator.RuleFor(x => x.CreditCard).Must(creditCard => !string.IsNullOrEmpty(creditCard)).WhenAsync(x => Task.Run(() => { return x.Age > 18; }));
		...
		[InlineData(42, null)]
		[InlineData(42, "")]
		public void ShouldHaveValidationError_should_not_throw_when_there_are_validation_error_WhenAsyn(int age, string cardNumber)
		{
		...
		public void ShouldHaveValidationError_should_throw_when_there_are_not_validation_error_WhenAsyn(int age, string cardNumber)
		{
			Person testPerson = new Person()
			{
				CreditCard = cardNumber,
		...
		[InlineData(17, "")]
		[InlineData(17, "cardNumber")]
		public void ShouldNotHaveValidationError_should_throw_when_there_are_not_validation_error_WhenAsyn(int age, string cardNumber)
		{
			Person testPerson = new Person()
			{
				CreditCard = cardNumber,
		...
		[InlineData(42, null)]
		[InlineData(42, "")]
		public void ShouldNotHaveValidationError_should_throw_when_there_are_validation_error_WhenAsyn(int age, string cardNumber)
		{
			Person testPerson = new Person()
			{
				CreditCard = cardNumber,
