...
FluentValidation has adopted the code of conduct defined by the Contributor Covenant, which can be found on the [.NET Foundation Code of Conduct website](http://www.dotnetfoundation.org/code-of-conduct).
